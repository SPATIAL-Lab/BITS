...
lines(1:t,MCMC.inv.l.Rin.m.89[[1]],lwd = 2, col = "firebrick4")
lines(1:t,MCMC.inv.l.Rin.m.89[[2]], lwd = 1, lty = 2, col = "firebrick4")
lines(1:t,MCMC.inv.l.Rin.m.89[[3]], lwd = 1, lty = 2, col = "firebrick4")
legend(0, 0.716, c("Micromill","Reconstructed input"),lwd = c(2, 2), col=c("blue","firebrick4"))
