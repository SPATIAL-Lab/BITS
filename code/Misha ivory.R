...
#####testing version 2 of the model with evaluation on the mean of neighbouring data points##
R.sd.mea <- misha$sd
dist.mea <- misha$dist
R.mea <- misha$mean
n.mea = length(dist.mea)
...
plot(density(post.misha.inversion2$BUGSoutput$sims.list$Ivo.rate),type="l")
